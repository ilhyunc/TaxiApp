...
class LocationSearchViewModel: NSObject, ObservableObject {
    ...
    func computeRidePrice(forType tpye: RideType) -> Double {
        guard let destCoordinate = selectedTaxiLocation?.coordinate else { return 0.0 }
        ...
        return tpye.computePrice(for: tripDistanceInMeters)
    }
    ...
    func configurePickUpDropOffTimes(with expectedTravelTime: Double) {
